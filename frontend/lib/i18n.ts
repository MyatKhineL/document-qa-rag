...
export const translations = {
  en: {
    ...
    errorTimeout: "The server took too long to respond. It may just be waking up — please try again.",
    retry: "Try Again",
    wakeHint: "This is taking longer than usual — the server may be waking up from sleep. Please wait a moment...",
    uploadedBadge: "Uploaded successfully",
    uploadAnother: "Upload a Different Document",
  ...
  ja: {
    ...
    errorTimeout: "サーバーの応答に時間がかかりすぎました。サーバーが起動中の可能性があります。もう一度お試しください。",
    retry: "再試行",
    wakeHint: "通常より時間がかかっています。サーバーがスリープから復帰している可能性があります。しばらくお待ちください...",
    uploadedBadge: "アップロード完了",
    uploadAnother: "別のドキュメントをアップロード",
    sourcesLabel: "出典",
